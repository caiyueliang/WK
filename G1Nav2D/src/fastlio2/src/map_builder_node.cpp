...
int main(int argc, char **argv)
{
    ...
    g_map_path = "/workspace/WK/G1Nav2D/src/fastlio2/PCD/map.pcd";
    g_ground_map_path = "/workspace/WK/G1Nav2D/src/fastlio2/PCD/ground_map.pcd";
    g_keyposes_path = "/workspace/WK/G1Nav2D/src/fastlio2/path/key_poses.txt";
    map_builder.run();
